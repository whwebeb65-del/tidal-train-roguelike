...
const definitions: readonly BattleUpgradeDefinition[] = [
  ...
  { id: 'split-tide-arrow', kind: 'skill-variant', skillId: 'tidal-volley', maxLevel: 1, requiredRank: 1 },
  ...
  { id: 'bursting-bubble', kind: 'skill-variant', skillId: 'bubble-barrier', maxLevel: 1, requiredRank: 1 },
  ...
  { id: 'undertow-eye', kind: 'skill-variant', skillId: 'extreme-tide', maxLevel: 1, requiredRank: 1 },
