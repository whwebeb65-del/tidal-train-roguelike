...
> = {
  ...
  'rank-tidal-volley': { name: '浪箭鱼群', effect: '潮汐齐射 潮阶 +1', synergy: '提高总伤害、缩短冷却并强化徽章' },
  'rank-bubble-barrier': { name: '珊甲泡膜', effect: '泡泡屏障 潮阶 +1', synergy: '提高治疗与护盾并强化徽章' },
  'rank-extreme-tide': { name: '涡星潮眼', effect: '极潮爆发 潮阶 +1', synergy: '提高爆发伤害并强化徽章' },
