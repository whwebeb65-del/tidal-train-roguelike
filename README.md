...
- 日期：2026-07-16
- 当前结论：已完成规则层、存档、三货币、地图开放、互动奖励、首通奖励、埋点、平台 Mock、确定性战斗循环、异步列车队、军团周远征和浏览器可玩流程
...
浏览器打开 `http://127.0.0.1:4173/` 即可试玩。可以在“车站”中加入潮汐灯塔团、选择两名异步支援队友、查看三种货币、升级车站和地图开放；进入同一局后可重复点击互动点领取分段奖励，连续开炮积累潮汐动能，再用技能、维修和潮汐爆发完成战斗。结算会累计军团远征贡献，达到里程碑后可领取确定性奖励。
